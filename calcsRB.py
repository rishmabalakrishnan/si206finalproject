...
def personality_bar_chart(pers_dict):
    ...
    plt.bar(personalities, frequencies, color=['lightpink', 'sandybrown', 'gold', 'yellowgreen', 'paleturquoise', 'powderblue', 'thistle', 'lightgray'])
...
def species_bar_chart(spec_dict):
    ...
    ax.set_ylabel('Number of Villagers')
    plt.bar(species, frequencies, color=['lightpink', 'sandybrown', 'gold', 'yellowgreen', 'paleturquoise'])
